...
public class DbCompanyManager {
    ...
    public static final String IS_COMPANY_EXIST = "SELECT count(*) as counter FROM `coupon_project`.`companies` " +
    ...
    public static final String GET_SINGLE_COMPANY = "SELECT * FROM `coupon_project`.`companies` " +
            "WHERE id=?";
    public static final String CHECK_IF_COUPON_EXIST = "SELECT COUNT(*) as counter FROM `coupon_project`.`coupons` " +
